...
namespace React_Northwind.Models
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<ViewPSum> ViewPSum { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Student>(entity =>
            {
                ...
                entity.Property(e => e.Sage).HasColumnType("datetime");
            ...
            modelBuilder.Entity<ViewPSum>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("view_p_sum");

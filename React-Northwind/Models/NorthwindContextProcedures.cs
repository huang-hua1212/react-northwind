...
namespace React_Northwind.Models
{
    ...
    public partial class NorthwindContextProcedures : INorthwindContextProcedures
    {
        ...
        public virtual async Task<List<CustOrderHistResult>> CustOrderHistAsync(string CustomerID, OutputParameter<int?> product_count, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterproduct_count = new SqlParameter
            {
                ParameterName = "product_count",
                Direction = System.Data.ParameterDirection.InputOutput,
                Value = product_count?._value ?? Convert.DBNull,
            ...
            var sqlParameters = new []
            {
                ...
                parameterproduct_count,
                parameterreturnValue,
            };
            var _ = await _context.SqlQueryAsync<CustOrderHistResult>("EXEC @returnValue = [dbo].[CustOrderHist] @CustomerID, @product_count OUTPUT", sqlParameters, cancellationToken);

            product_count.SetValue(parameterproduct_count.Value);
